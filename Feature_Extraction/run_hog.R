...
#storing feature vector for TRAINING images using HOG method
...
for(i in fileList)
{
  ...
  output <- paste("E:/Concordia projects/INSE 6180(Data Mining)/Code/output_hog_train/",i,".rds",sep= "")
  
  saveRDS(featureVector,file=output)
}


#storing feature vector for TESTING images using HOG method
...
for(i in fileList1)
{
  ...
  output1 <- paste("E:/Concordia projects/INSE 6180(Data Mining)/Code/output_hog_test/",i,".rds",sep= "")
