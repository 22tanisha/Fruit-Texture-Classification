naive_bayes <- function(testdata, traindata, t_labels){
  ...
  #Calculating likelihood for each feature of each class and also calculating posterior probability
...
#Getting features generated from LBP for testing images and creating testingMatrix
